            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">The need for blood</h4>
                        ...
                        <p class="card-text" style="padding-left:2%">Have iron-rich foods, such as red meat, fish, poultry, beans, spinach, iron-fortified cereals or raisins. </p>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">Blood Tips</h4>
                        ...
                        <p class="card-text" style="padding-left:2%">Ask a friend to donate at the same time . You can support each other and do twice as much good! </p>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card">
